/*
Copyright 2015, kg/overlay@1.0.2
MIT Licensed
build time: Wed, 04 Feb 2015 13:06:47 GMT
*/
define("kg/overlay/0.0.1/index", ["node","ua","event-dom/gesture/tap","util","kg/xtemplate/4.1.4/runtime","kg/component/0.0.1/container","kg/component/0.0.1/extension/shim","kg/component/0.0.1/extension/align","kg/component/0.0.1/extension/content-box"], function(require, exports, module) {
...
var componentContainer = require("kg/component/0.0.1/container");
var componentExtensionShim = require("kg/component/0.0.1/extension/shim");
var componentExtensionAlign = require("kg/component/0.0.1/extension/align");
var componentExtensionContentBox = require("kg/component/0.0.1/extension/content-box");
/*
combined modules:
overlay
overlay/control
...
overlayXtplDialog = function (exports) {
  ...
  var ret = exports = function dialog(undefined) {
    ...
    buffer.data += '';
    var callRet0;
    runtime.extendTpl = { params: ['./overlay'] };
    buffer = buffer.async(function (newBuffer) {
      runtime.extendTplBuffer = newBuffer;
    });
    runtime.extendTplFn = require({ params: ['./overlay'] }.params[0]);
